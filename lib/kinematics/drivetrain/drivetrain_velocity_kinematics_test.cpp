...
namespace {
TEST(DrivetrainKinematicsTest, TestXDriveInverseKinematics) {
  // TODO set up X-Drive
}

TEST(DrivetrainKinematicsTest, TestRotatedXDriveInverseKinematics) {
  // TODO set up X-Drive rotated 45 degrees
}

TEST(DrivetrainKinematicsTest, TestTriDriveInverseKinematics) {
  // TODO set up Tri-Drive (one in front)
}

TEST(DrivetrainKinematicsTest, TestInvertedTriDriveInverseKinematics) {
  // TODO set up inverted Tri-Drive (two in front)
}

TEST(DrivetrainKinematicsTest, TestTriDriveInverseKinematics) {
  // TODO set up Tri-Drive (one left)
}

TEST(DrivetrainKinematicsTest, TestTriDriveInverseKinematics) {
  // TODO set up Tri-Drive (one right)
}
